...
export const ManifestoSection = () => {
  ...
  return (
    <section ref={ref} className="px-4 sm:px-6 md:px-12 lg:px-20 py-20 md:py-32 relative overflow-hidden">
      <div className="liquid-blob w-[500px] h-[500px] bg-foreground/5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-blob" />
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        >
          <span className="text-[10px] sm:text-xs font-semibold tracking-[0.25em] uppercase text-muted-foreground mb-6 block">Manifesto</span>
          
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground leading-[1.15] mb-8">
            ...
            >
              <motion.span
                ...
                style={{ originX: 0 }}
              />
              <span className="relative z-10">I build it.</span>
            </motion.span>
          </h2>
